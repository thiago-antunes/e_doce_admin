class AdministradorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @administrador.save
        format.html { redirect_to @administrador, notice: "Administrador criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @administrador.update(administrador_params)
        format.html { redirect_to @administrador, notice: "Administrador alterado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administradors_url, notice: "Administrador apagado com sucesso." }
